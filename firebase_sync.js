...
var _FB_TOKEN = "dd8db47eb77b6f0c513042fbaa0544568b28710c4c00e7d8";
...
function fsSet(path, data, onOk, onErr){
  // Include secret token in every write for Firebase rule validation
  var payload = (typeof data === 'object' && data !== null && !Array.isArray(data))
    ? Object.assign({}, data, { _token: _FB_TOKEN })
    : data;
